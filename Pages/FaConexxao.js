...
function handleAboutChicot() {
 ...
 //==================redirecionamento pages Produtos de Eventos e Produtos Industriais=========================

 const aboutEvent = document.getElementById('about-event')
 aboutEvent.addEventListener('click' , handleAboutEvent)

 function handleAboutEvent() {
  window.open('../Pages/PlugsInjetados.html#prod-event')

 }

 const aboutIndustry = document.getElementById('about-industry')
 aboutIndustry.addEventListener('click' , handleAboutIndustry )
function handleAboutIndustry() {
