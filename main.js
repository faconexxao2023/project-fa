...
function clickHandleChicot() {
 ...
 //==================redirecionamento pages produtos de Eventos e produtos Indústriais =========================

 const buttonPlugEvent = document.getElementById('btn-event')
 buttonPlugEvent.addEventListener('click' , handlePlugEvent)

 function handlePlugEvent() {
  window.open('./Pages/PlugsInjetados.html#prod-event')

 }

 const buttonPlugIndustry = document.getElementById('btn-industry')
 buttonPlugIndustry.addEventListener('click' , handlePlugIndustry )

 function handlePlugIndustry() {
